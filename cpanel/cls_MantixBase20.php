...
//var $id;
        ...
        switch($this->datos->c_error) {
            ...
            case 16:
                if($this->mensaje_error=="")
                    if(mysql_errno()==1062)
                        return "Hubo un error al intentar insertar el registro: El registro ya existe";
                    else
                        return mysql_error();
                else
    ...
    function actualizar() {
        ...
        if($this->datos->c_error!=0) {
            if($this->mensaje_error=="") {
                if(mysql_errno()==1062)
                    return "Hubo un error al intentar actualizar el registro: El registro ya existe";
                else
                    return mysql_error();
            }
            else
