...
<div class="caritem">
    ...
    <div class="cararriba">
        ...
        <div class="carcolarritemrojo"><?=$r->tipodecoche ?></div>
        <div class="carcolarritem"><?=$r->kilometraje ?> Km</div>
        <div class="carcolarritem"><?=substr($r->inserted,-7) ?></div>
    ...
    <div class="cardetalles"><p><?=limitar_letras($r->resumen,256) ?></p></div>
</div>
        <?php if(isset($_SESSION["usuarioFE"])) {
            echo '<div class="carespecial">PVE: '.number_format($r->pve, 2, ",", ".").' &euro;</div>';
        } ?>
